...
//                 (item) =>
//                   `<li><a href="${item.link}">${item.title}</a>${item.postType === 'post' ? ` by ${item.authorName}` : ''}</li>`
//               )
//               .join("")}
//           ${results.length ? "</ul>" : ""}
//           </div>
...
//               ? ''
//               : `<p>No campuses events that search. <a href="${universityData.root_url}/events">View all events</a></p>`
//           }
//             ${results.events.map(
//                 (item) =>
//                   `<div class="event-summary">
